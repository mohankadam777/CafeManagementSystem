...
public class CategoryService {
	...
	public ResponseEntity<String> addCategory(Map<String, String>requestMap) {
		...
		return new ResponseEntity<>(CafeConstants.SOMETHING_WENT_WRONG, HttpStatus.CREATED);
	}
	/////////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////////////
	public ResponseEntity<List<Category>> getCategory(Boolean useCase) {
		try {
//			if (false) {
			if (useCase==null) {
...
//				System.err.println("Hello");s
	...
	public ResponseEntity<String> updateCategory(Map<String, String>requestMap) {
		...
		try {
			...
			if(validateCategoryMap(requestMap,false)) {
				Optional<Category> catOptional=categoryRepo.findById( Long.parseLong(requestMap.get("id")) );
